Написать 3 SQL-запроса к этой схеме: 1) Найти все книги автора "X". 2) Найти всех читателей, которые сейчас держат у себя книгу Y (используя LEFT JOIN и WHERE ... IS NOT NULL). 3) Найти все книги, которые ни разу не брали.
1 задание:
